            ...
            <div className="about-wrapper">
                <div className="row">
                        <div className=" col-lg-4">
                            ...
                            <h3 className="About-tittle pe-lg-5">
                                About Me :
                            </h3>
                        ...
                        <div className=" col-lg-8 p-lg-0">
                            ...
                            <p className="about-description ms-auto">
                                <span className='d-flex d-md-inline justify-content-start'>Get in touch <i className="fa fa-envelope"></i></span><a href="mailto:riddheshdesai56@gmail.com">riddheshdesai56@gmail.com</a>
                            </p>
                        </div>
                </div>
                <div className="row skill-section">
                        <div className="col-lg-4">
                            <div className="tittle-container d-flex justify-content-lg-end">
                                <h3 className="Skill-tittle pe-lg-5">
                                    Skills :
                                </h3>
                            </div>
                        </div>
